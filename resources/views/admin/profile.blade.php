    ...
    <div class="col-sm-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                @endif
                <div class="media">
                    <img class="mr-3" style="max-width: 75px;" src="{{ asset('sb-admin/img/undraw_profile.svg') }}"
                        alt="Generic placeholder image">
                    <div class="media-body">
                        <h5 class="mt-0">{{ $admin->name }}</h5>
                        <div class="row no-gutters">
                            <div class="col">Email: {{ $admin->email }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.profile-pass') }}" method="post">
                    @csrf
                    <div class="row">
