...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('mbti.development.update',$dev->id) }}" method="POST">
            @csrf
            @method('POST')
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <select name="mbti_interprestation_id" class="form-control" id="interprestation">
                        ...
                        <option value="{{ $item->id }}" @if ($dev->mbti_interprestation_id == $item->id)
                            selected
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="development_suggestion" value="{{ $dev->development_suggestion }}" class="form-control">
                    </div>
