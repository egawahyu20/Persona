...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah karakteristik</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data karakteristik</h6>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('mbti.characteristic.store') }}" method="POST">
            @csrf
            @method('POST')
            <div class="row">
