...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Karakter MBTI</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Karakter MBTI</h6>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('mbti.characteristic.update',$char->id) }}" method="POST">
            @csrf
            @method('POST')
            <input type="hidden" value="{{ $char->id }}" name="id">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <select name="mbti_interprestation_id" class="form-control" id="interprestation">
                        ...
                        <option value="{{ $item->id }}" @if ($char->mbti_interprestation_id == $item->id)
                            selected
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="characteristic" value="{{ $char->characteristic }}" class="form-control">
                    </div>
